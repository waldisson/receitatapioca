    ...
    <SafeAreaView style={styles.sobremesas}>
      <ScrollView>
        <View>
          ...
          <Text style={styles.titulo}>TAPIOCA DE CHOCOLATE</Text>
          <Text style={styles.h1}>Resumo:</Text>
          <Text style={styles.txtResumo}>
            Tapioca muito deliciosa com cacau.{' '}
          </Text>
          ...
          <View style={styles.areaIconSeta}>
            ...
            />
            <Text>3 col. (sopa) rasas de goma de tapioca;</Text>
          </View>
          ...
          <View style={styles.areaIconSeta}>
            <Image
              ...
              style={styles.iconSeta}
            />
            <Text>1 col. (sobremesa) rasa de cacau;</Text>
          </View>
          ...
          <View style={styles.areaIconSeta}>
            <Image
              ...
              style={styles.iconSeta}
            />
            <Text>1 col. (chá) de açúcar de coco;</Text>
          </View>
          ...
          <Text style={styles.txtPreparo1}>
            Misture bem a tapioca, o cacau e o açúcar de coco e coloque numa
            frigideira antiaderente bem quente. Retire e recheie com rodelas de
            banana.
          </Text>

          <Text style={styles.h2}>fonte: https://vilamulher.com.br</Text>
        </View>
      </ScrollView>
